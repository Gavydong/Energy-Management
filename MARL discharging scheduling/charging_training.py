...
def main():
    ...
    for e in range(episode_count + 1):
        ...
        while state_date<datetime.strptime("2018-05-01","%Y-%m-%d"):
            ...
            #print("reward: ",reward)
            peak_shave = Shaved_value.min() - state_value.min()
...
#    validation_peak_shave_save.to_csv("data/validation_peak_shave.csv", sep=",", index=False)
    if not os.path.exists("5charge"):
        os.mkdir("5charge")
    model_1.save("5charge_models/model_agent_1")
    model_2.save("5charge_models/model_agent_2")
    model_3.save("5charge_models/model_agent_3")
    model_4.save("5charge_models/model_agent_4")
    model_5.save("5charge_models/model_agent_5")
